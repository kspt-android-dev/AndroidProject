...
class GameboardTest {
    ...
    fun gameboardInitialTest() {
        val gameboard =
            Gameboard(FieldSize.RUSSIAN)
        val clr = Color.WHITE
        val st = CheckerState.ON_FIELD
        val tp = CheckerType.MAN
        val possibleMovements = hashMapOf(Pair(
            Checker(
                clr,
                Coordinate(5, 0),
                tp,
    ...
    fun kingMoveTestLeft() {
        val board = arrayOf(
            ...
            arrayOf<Checker?>(null, null, null, null, null, null, null, null),
            arrayOf<Checker?>(null, null, null, null, null, null, null,
                Checker(
                    Color.BLACK,
                    Coordinate(4, 7),
                    CheckerType.MAN,
            ...
            arrayOf<Checker?>(null, null, null, null,
                Checker(
                    Color.WHITE,
                    Coordinate(5, 4),
                    CheckerType.KING,
    ...
    fun kingMoveTestRight() {
        val board = arrayOf(
            ...
            arrayOf<Checker?>(null, null, null, null, null, null, null, null),
            arrayOf<Checker?>(null, null, null, null, null,
                Checker(
                    Color.WHITE,
                    Coordinate(2, 1),
                    CheckerType.MAN,
    ...
    fun kingStrokeTestLeftForward() {
        val board = arrayOf(
            ...
            arrayOf<Checker?>(null, null, null, null, null, null, null, null),
            arrayOf<Checker?>(null, null, null,
                Checker(
                    Color.BLACK,
                    Coordinate(4, 3),
                    CheckerType.MAN,
    ...
    fun kingStrokeTestRightBack() {
        val board = arrayOf(
            ...
            arrayOf<Checker?>(null, null, null, null, null, null, null, null),
            arrayOf<Checker?>(null, null, null, null, null, null, null, null),
            arrayOf<Checker?>(null, null, null, null, null, null,
                Checker(
                    Color.WHITE,
                    Coordinate(5, 6),
                    CheckerType.KING,
